# Contributing to LlamaScrapes3

Thank you for your interest in contributing to LlamaScrapes3! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaScrapes3:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamascrapes3.git
   cd llamascrapes3
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamascrapes3.git
   ```
...
By contributing to LlamaScrapes3, you agree that your contributions will be licensed under the project's MIT License.
