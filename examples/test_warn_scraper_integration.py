...
try:
    ...
    print("Error: Elysian Lens package not found. Please install with 'pip install -e .'")
    sys.exit(1)
...
def main():
    ...
    parser.add_argument("--extract-links", action="store_true", 
                        help="Extract links from scraped pages")
    parser.add_argument("--extract-images", action="store_true", 
                        help="Extract images from scraped pages")
    parser.add_argument("--download-images", action="store_true", 
                        help="Download extracted images")
    parser.add_argument("--proxy", help="Proxy URL in format protocol://user:pass@host:port")
    ...
    if not is_available():
        print("Error: warn-scraper is not available. Install it with 'pip install warn-scraper'.")
        sys.exit(1)
