"""
Client module for llamascrapes3.
"""
...
class Client:
    """Main client for interacting with the llamascrapes3 API."""
    ...
    def __init__(self, api_key=None, base_url=None, config=None):
        ...
        self.base_url = base_url or "https://api.llamasearch.ai/llamascrapes3"
